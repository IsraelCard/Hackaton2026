...
`;
  ...
  try {
    ...
    // Allying with @google/genai SDK best practices from skills
      ...
      config: {
        ...
        responseSchema: {
          ...
          properties: {
            ...
            best_time_to_leave: { type: Type.STRING },
            detected_events: { 
              type: Type.ARRAY, 
          ...
          required: ["summary", "best_time_to_leave", "detected_events", "risk_level"]
        }
      }
    });
