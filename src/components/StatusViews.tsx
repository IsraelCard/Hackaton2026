  ...
  return (
    ...
    >
      <div className="relative w-32 h-32 mb-10">
        <div className="absolute inset-0 border-8 border-zinc-100 dark:border-zinc-800 rounded-[40px]" />
        <div className="absolute inset-0 border-8 border-blue-600 rounded-[40px] border-t-transparent animate-spin" />
