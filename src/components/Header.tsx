...
export default function Header({ todayStr, isDark, toggleTheme }: HeaderProps) {
  return (
    <nav className="w-full bg-white dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800 py-4 px-8 flex justify-between items-center sticky top-0 z-50 transition-colors">
      ...
      <div className="flex items-center gap-6">
        ...
        <button 
          onClick={toggleTheme}
          className="w-10 h-10 rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-zinc-900 dark:text-white hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-all shadow-sm"
